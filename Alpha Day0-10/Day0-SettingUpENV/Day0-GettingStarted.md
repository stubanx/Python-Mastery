Hello, and welcome to Day 0 of your Python programming journey! Today, we'll set up your development environment by installing Python and Visual Studio Code (VSCode). Here's how you can do it:
